...
namespace DomingoRoofWorks.Controllers
{
    public class MaterialsController : Controller
    {
        ...
        public MaterialsController(DomingoRoofWorksContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MaterialID,Name,Description")] Material material)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaterialID,Name,Description")] Material material)
        {
